...
const Index = () => {
  ...
  return (
    <div className="flex justify-end items-center flex-col h-screen">
      ...
      <div className="flex-1 flex justify-center border-2  w-full mb-2 overflow-scroll">
        {loading ? (
          ...
          <>
            {!!chart ? (
              ...
              <div className="flex flex-col justify-center text-white">
                <h1 className="text-7xl font-black">Let's create</h1>
                <h3 className="text-8xl font-black text-success">UML Diagram</h3>
        ...
        <form onSubmit={handleFlow} className="form-control">
          ...
          />
            <input
              ...
              type="text"
              placeholder="What the UML diagram is about"
              autoFocus="on"
            />
            <button
              type="submit"
            
              className={`btn btn-grad btn-lg bg-orange-600 ${loading ? "loading" : ""}`}
            >
              {error ? "Retry" : "Generate UML"}
            </button>
          {/* </div> */}
          {/* <SelectTemplate
            onChange={(e) => setSelectedTemplate(e.target.value)}
